...
// 商品查询列表 api
export const apiProducts = async (payload: ProductPayload): Promise<ProductListResponse> => http.get(`/api/product/list?page=${payload.page}&pageSize=${payload.pageSize}`)
